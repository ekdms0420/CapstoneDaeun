...
export default {
  ...
  methods: {
    // persist () {
    //   this.$store.commit('changeOilMonth', this.month)
    //   // localStorage.setItem('engineOil_month', this.$store.state.engineOil_month)
    //   this.$store.commit('changeBatteryMonth', this.month)
    // }
    startVehicle () {
    ...
    go () {
      ...
      storage.saveBatteryM(this.setMonth)
