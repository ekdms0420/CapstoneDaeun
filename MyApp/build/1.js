...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_managepopup_vue__ = __webpack_require__(224);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_dffb35f2_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_managepopup_vue__ = __webpack_require__(228);
var disposed = false
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_managepopupBattery_vue__ = __webpack_require__(230);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_397cbcb6_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_managepopupBattery_vue__ = __webpack_require__(238);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_battery_vue__ = __webpack_require__(241);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a9e52ca6_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_battery_vue__ = __webpack_require__(248);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var _manageLibs = __webpack_require__(221);

var _vuejsDatepicker = __webpack_require__(223);
...
exports.default = {
  ...
  methods: {
    ...
    go: function go() {
      ...
      _manageLibs.storage.saveEngineOilM(this.setMonth);
      _manageLibs.storage.saveBatterykm(this.distance);
      _manageLibs.storage.saveBatteryM(this.setMonth);
...
var _managepopup = __webpack_require__(215);

var _managepopup2 = _interopRequireDefault(_managepopup);

var _managepopupBattery = __webpack_require__(217);

var _managepopupBattery2 = _interopRequireDefault(_managepopupBattery);

var _vueSimpleProgress = __webpack_require__(235);
...
exports.default = {
  ...
  components: {
    ...
    'manage-popupBattery': _managepopupBattery2.default,
  ...
  data: function data() {
    return {
      ...
      mon_max: 36,
      mon_value: 3,
      items: [{ name: '엔진 오일' }, { name: '배터리' }, { name: '냉각수' }, { name: '타이어' }],
      battery: '0',
      km: 0,
      month: 0
    };
  ...
  mounted: function mounted() {
    ...
    this.month = _manageLibs.storage.loadBatteryM();
  },

  methods: {
    gomanage: function gomanage(pos) {
      var str = '/';
      if (pos === '배터리') {
        str += 'battery';
      } else if (pos === '엔진 오일') {
      ...
      _c("div", { staticClass: "manage" }, [
        ...
        _c("div", { staticClass: "detail" }, [
          _c("div", { staticClass: "api" }, [
            ...
            _c("span", [_vm._v(" : ")]),
            _c("span", [_vm._v(_vm._s(_vm.battery))])
          ]),
          _vm._v(" "),
